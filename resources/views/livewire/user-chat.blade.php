<ul class="overflow-auto" style="height: 750px;">
    <li>
        @foreach ($userschats as $chat)
            <a href="{{ '/chat/'.$chat->id }}" class="hover:bg-gray-700 border-b border-gray-700 px-3 py-2 cursor-pointer flex items-center text-sm focus:outline-none focus:border-gray-300 transition duration-150 ease-in-out">
